...
public class GetSimSwapStatus extends commonBase{
	...
	public GetSimSwapStatus(DataFunctions data, UtilityFunctions utils, Reporting repo) {
		this.data = data;
        this.utils = utils;
        this.repo = repo;
	}
	...
	//remove system name
	public void getsimswapstatus(String sDBURL, String sUserName, String sPassword, String sQuery, String sStatus, String sMessage, ExtentTest test) throws Exception {
	...
	//remove new Sim number
	public void removeNewSimNumber(String sDBURL, String sUserName, String sPassword, String sQuery, String sStatus, String sMessage, ExtentTest test) throws Exception {
		...
		// EXECUTE PROCEDURE su_epx_api('UPD_SBD_BASIC')
		String query_mah_retrieve = "execute procedure swp_epx_api('GET_SIMSWAP_STATUS','ssa_msisdn=["+sMSISDN[1]+"]','ssa_orig_sim=["+sSSA_orig_sim[1]+"]','ssa_new_sim=[]','SS','COMMENTS=[Old Sim Card Located],ICAPCHK=[N],SIMCHK=[Y],AAFLAG=[N],IMMEDIATE=[Y],','W1','MII','MIISimSwaps','rademeza')";
		resultset = data.ConnectAndQueryEPPIXServer(sDBURL, sUserName, sPassword, query_mah_retrieve);
	...
	public void removeSystemApplication(String sDBURL, String sUserName, String sPassword, String sQuery, String sStatus, String sMessage, ExtentTest test) throws Exception {
		...
		// EXECUTE PROCEDURE su_epx_api('UPD_SBD_BASIC')
		String query_mah_retrieve = "execute procedure swp_epx_api('GET_SIMSWAP_STATUS','ssa_msisdn=["+sMSISDN[1]+"]','ssa_orig_sim=["+sSSA_orig_sim[1]+"]','ssa_new_sim=["+sSSa_new_sim[1]+"]','SS','COMMENTS=[Old Sim Card Located],ICAPCHK=[N],SIMCHK=[Y],AAFLAG=[N],IMMEDIATE=[Y],','W1','MII','','rademeza')";
		resultset = data.ConnectAndQueryEPPIXServer(sDBURL, sUserName, sPassword, query_mah_retrieve);
