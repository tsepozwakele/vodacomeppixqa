...
public class PROPOSED_INVOICE_API_with_PROPTOT_remove_system_application extends commonBase {
	...
	String[] p_status = new String[3];


	@Test
	public void f() throws Exception {
		
		TCID = "IES_658";																						//Test case ID
		parent = repo.setParent(TCID + " Proposed_invoce");
		test = repo.setChildNode("PROPOSED_INVOICE_API_with_PROPTOT_remove_system_application", parent);		//Test case Name
		...
		String propInvoice = "EXECUTE PROCEDURE 'informix'.epx_proposed_api('PROPTOT','"+ vam_msisdn_no[1] +"','','eppix','Molokommes',user)";
