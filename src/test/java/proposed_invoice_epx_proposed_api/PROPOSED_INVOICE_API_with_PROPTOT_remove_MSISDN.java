...
/*
 *  Name of the test  : PROPOSED_INVOICE_API_with_PROPTOT_remove_MSISDN
...
public class PROPOSED_INVOICE_API_with_PROPTOT_remove_MSISDN extends commonBase {
	...
	public void f() throws Exception {
		...
		TCID = "IES_656";																							//Test case ID
		parent = repo.setParent(TCID + " Proposed_invoce");
		test = repo.setChildNode("PROPOSED_INVOICE_API_with_PROPTOT_remove_system_MSISDN", parent);					//Test case name
		...
		String propInvoice = "EXECUTE PROCEDURE 'informix'.epx_proposed_api('PROPTOT',' ','eppix','eppix','Molokommes',user)";
