...
public class PROPOSED_INVOICE_API_with_PROPOSED_remove_system_username extends commonBase {
	...
	public void f() throws Exception {
		...
		TCID = "IES_654";																					//Test case ID
		parent = repo.setParent(TCID + " Proposed_invoce");													
		test = repo.setChildNode("PROPOSED_INVOICE_API_with_PROPOSED_remove_eppix_system_username", parent);		//Test case name
		...
		//Execute stored proc
		String propInvoice = "EXECUTE PROCEDURE 'informix'.epx_proposed_api('PROPOSED','"+ vam_msisdn_no[1] +"','eppix','eppix','',user)";
		...
		try {
			...
			System.out.println("Obtain Execute_PROPOSED SP Details, No system username found.");
			repo.childLogPass("Obtain Execute_PROPOSED SP Details, No system username found.", "No System User Parameter was speficied.", "No System User Parameter was speficied.", false, test, utils);
		}
