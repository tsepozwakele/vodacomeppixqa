...
public class Verify_get_sbd_name_adr_Retrieve_subscriber_details_without_MSISDN extends commonBase {
    ...
    //String[] sIDnumber = new String[3];
		...
		public void f() throws Exception {
		      TCID = "IES-689";
		                   parent = repo.setParent(TCID +"Verify get sbd name adr - Retrieve the subscriber details without MSISDN");
		                   test = repo.setChildNode("Verify get sbd name adr - Retrieve the subscriber details without MSISDN", parent);
		                   ...
		                   if (resultset != null) {
		                                  ...
		                                  repo.childLogPass("Verify get sbd name adr - Retrieve the subscriber details without MSISDN","Retrieved the subscriber details without MSISDN",
		                                                                "Retrieved the subscriber details without MSISDN", false, test, utils);
		                   ...
		                   String query_mah_retrieve = "execute procedure su_epx_api('GET_SBD_NAME_ADR','MSISDN=[],USER=[viandah],','','','','')";
		                   ...
		                   if (sResults2 != null) {
		                                  ...
		                                  if (Compare[1].equals("EPX_STATUS=[E]") && Compare[2].equalsIgnoreCase("MESSAGE=[Select from vam_active_msisdn table Failed]")) {
		                                                 ...
		                                                 repo.childLogPass("Verify get sbd name adr - Retrieve the subscriber details without MSISDN",
		                                                                               ""+Compare[1]+","+Compare[2]+"",
