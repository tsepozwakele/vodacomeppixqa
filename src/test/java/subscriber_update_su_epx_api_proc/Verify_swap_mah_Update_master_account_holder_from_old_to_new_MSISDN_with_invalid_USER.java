...
public class Verify_swap_mah_Update_master_account_holder_from_old_to_new_MSISDN_with_invalid_USER extends commonBase {
	...
	String[] sMadflag = new String[3];
	  ...
	  public void f() throws Exception {
		  TCID = "1234";
		  parent = repo.setParent(TCID +" Verify swap_mah - Update master account holder from old to new MSISDN with invalid User");
			test = repo.setChildNode("Update master account holder from old to new MSISDN with invalid User", parent);
	    ...
	    String strSwapMAH = "execute procedure su_epx_api('SWAP_MAH','NEW_MSISDN=["+sMSISDN[2]+"],OLD_MSISDN=["+sMSISDN[1]+"],APPLICATION_ID=[MII],USER=[123Tse!]','','','','')";
