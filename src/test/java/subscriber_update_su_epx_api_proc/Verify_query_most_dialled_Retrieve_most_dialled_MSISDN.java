...
public class Verify_query_most_dialled_Retrieve_most_dialled_MSISDN extends commonBase {
    ...
    //String[] sIDnumber = new String[3];
		...
		public void f() throws Exception {
		      TCID = "696";
		                   parent = repo.setParent(TCID +"Verify query most dialled - Retrieve most dialled MSISDN");
		                   test = repo.setChildNode("Verify query most dialled - Retrieve most dialled MSISDN", parent);
		                   ...
		                   String query_mah_retrieve = "execute procedure su_epx_api('QUERY_MOST_DIALLED',' USER=[duraanwy],MSISDN=["+sMSISDN[1]+"],','','','','')";
		                   ...
		                   if (sResults2 != null) {
		                                  ...
		                                  if (Compare[1].equals("EPX_STATUS=[E]") && Compare[2].equalsIgnoreCase("MESSAGE=[Data fetch successfull!]")) {
