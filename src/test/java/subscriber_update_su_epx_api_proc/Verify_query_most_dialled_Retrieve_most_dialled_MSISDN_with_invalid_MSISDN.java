...
public class Verify_query_most_dialled_Retrieve_most_dialled_MSISDN_with_invalid_MSISDN extends commonBase {
    ...
    //String[] sIDnumber = new String[3];
		...
		public void f() throws Exception {
		      TCID = "696";
		                   parent = repo.setParent(TCID +"Verify query most dialled - Retrieve most dialled MSISDN with invalid MSISDN");
		                   test = repo.setChildNode("Verify query most dialled - Retrieve most dialled MSISDN with invalid MSISDN", parent);
		                   ...
		                   if (resultset != null) {
		                                  ...
		                                  repo.childLogPass("Verify query most dialled - Retrieve most dialled MSISDN with invalid MSISDN","Retrieved most dialled MSISDN",
		                                                                "Retrieved the master account holder for a specified MSISDN with invalid MSISDN", false, test, utils);
		                   ...
		                   String query_mah_retrieve = "execute procedure su_epx_api('QUERY_MOST_DIALLED',' USER=[Tsepo],MSISDN=[1234],','','','','')";
		                   ...
		                   if (sResults2 != null) {
		                                  ...
		                                  if (Compare[1].equals("EPX_STATUS=[C]") && Compare[2].equalsIgnoreCase("MESSAGE=[No dialled nrs found in last 30 days.]")) {
