...
public class Verify_get_info_Retrieve_contract_balance extends commonBase {
  ...
  public void f() throws Exception {
	  TCID = "IES-692";
	  	parent = repo.setParent(TCID +"Verify_get_info_Retrieve_contract_balance");
	  	test = repo.setChildNode("Verify_get_info_Retrieve_contract_balance", parent);
		...
		String strSwapMAH = "execute procedure su_epx_api('GET_INFO','MSISDN=[" +sMSISDN[1]
				+ "],USER=[viandah],TYPE=[show_balofcon],OPTION=[ ]','','','','')";
