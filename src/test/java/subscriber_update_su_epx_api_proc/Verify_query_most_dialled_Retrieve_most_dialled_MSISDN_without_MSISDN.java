...
public class Verify_query_most_dialled_Retrieve_most_dialled_MSISDN_without_MSISDN  extends commonBase{
    ...
    //String[] sIDnumber = new String[3];
		...
		public void f() throws Exception {
		      TCID = "696";
		                   parent = repo.setParent(TCID +"Verify query most dialled - Retrieve most dialled MSISDN without MSISDN");
		                   test = repo.setChildNode("Verify query most dialled - Retrieve most dialled MSISDN without MSISDN", parent);
		                   ...
		                   if (resultset != null) {
		                                  ...
		                                  repo.childLogPass("Verify query most dialled - Retrieve most dialled MSISDN without MSISDN","Retrieved most dialled MSISDN",
		                   ...
		                   if (sResults2 != null) {
		                                  ...
		                                  if (Compare[1].equals("EPX_STATUS=[E]") && Compare[2].equalsIgnoreCase("MESSAGE=[Back-end process may have terminated abnormally. The request id is 1041259026.,]")) {
